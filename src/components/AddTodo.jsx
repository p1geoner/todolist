    ...
    function submitHandler(event) {
        ...
        if(dateValue!==''){
            if(timeValue!==''){
                ...
                let fullDate=year+'/'+month+'/'+day+'/'+hours+'/'+mins;
    ...
    return(
        <form className="addTodo" action="" onSubmit={submitHandler}>
            <div className="addTodo__container">
                <button className="addTodo__btn"><img src={AddLogo} alt="" /></button>
                <input 
            ...
            <div className="addTodo__container">
                <input type="date" onChange={event=>setDateValue(event.target.value)} required/>
                <input type="time" onChange={event=>setTimeValue(event.target.value)} required/>
            </div>
